    ...
    return (
      <form className="reviews__form form" onSubmit={(evt) => {
        ...
        <div className="reviews__rating-form form__rating">
          ...
          <input className="form__rating-input visually-hidden" onChange={(evt) => {
        ...
        <textarea className="reviews__textarea form__textarea" onChange={(evt) => {
          this.setState = evt.target.value;
        }} id="review" name="review" placeholder="Tell how was your stay, what you like and what can be improved"></textarea>
